...
class Detail(AuthSpotMixin):
  async def detail(
    ...
    *,
    ...
    References:
      Upstream docs: https://mexcdevelop.github.io/apidocs/spot_v3_en/#get-rebate-records-detail"""
  ...
  async def detail_paged(self, *, start_time: Timestamp | None = None, end_time: Timestamp | None = None, recv_window: int | None = None, timestamp: Timestamp | None = None, max_pages: int | None = None, validate: bool | None = None) -> AsyncIterator[Response200]:
